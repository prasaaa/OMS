					...
					<td style="width: 80%;">
						...
						ResultSet result,resultset_for_dropdown;
						 ...
						 if(session.getAttribute("change") != null)
						 {
							 ...
							 session_report_repair.setAttribute("report_repair", result);
							 while(result.next())
								{
								%>
								...
								<td style="height: 100%;background-color:white;">
									...
									<!-- form starts here  -->
										...
										<div class="container">
											...
											<form  name="myForm" action="Repair_Report_Filter_Controller" method="post" >
												...
												<input type="submit" value="Filter" style = "background-color:#008CBA;width:100%;">
												    ...
												    <br>
												    <form action = "Repair_REPORT_Controller"  method = "post">
