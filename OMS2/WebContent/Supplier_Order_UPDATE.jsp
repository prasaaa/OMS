					...
					<td style="width: 100%; height: 100%;">
						...
						<table style="height: 100%; width: 100%;position: relative;"  class="table table-bordered table-striped mb-0">
								...
								<td style="height: 40%;background-color:white;">
									...
									<!-- form starts here  -->
										...
										<div class="container">
											...
											<form action="Supplier_Order_Filter_Controller" method="post" >
							...
							function validateForm() {
							  var x = document.forms["myForm"]["pay_id_filter"].value;
							  if (x == "") {
							...
							<!-- notification two  -->
								<tr>
									<td>
											 <form action="Supplier_Order_UPDATE" method="post">
											
												
												<label>Order Date</label> <br> 
												<input type="date"	name="ord_date" placeholder="Order Date.." style = "width: 100%;
																														  padding: 12px;
																														  border: 1px solid #ccc;
																														  border-radius: 4px;
																														  box-sizing: border-box;
												...
												<label>Recieve Date</label> <br> 
												<input type="date"	name="rec_date" placeholder="Recieve Date.." style = "width: 100%;
																														  padding: 12px;
																														  border: 1px solid #ccc;
																														  border-radius: 4px;
																														  box-sizing: border-box;
												...
												<label>Supplier</label> <br> 
												<select id="supplierselect" name = "supplierselect" style = "width : 100% ;" >
												<option value=""></option>
												...
												<br>
												<label>Type</label> <br> 
												<select id="importselect_up" style = "width : 100%;" name = "type_up" >
													<option value=""></option>
													<option value="Local">Local</option>
													<option value="Foreign">Foreign</option>
