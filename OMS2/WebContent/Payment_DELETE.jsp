...
<%@page import="com.DatabaseHandle.Payment_SELECT"%>
					...
					<td style="width: 80%;">
						...
						//session.setAttribute("change", null);
						 if(session.getAttribute("change") != null)
						 {
							 ...
							 while(result.next())
								{
								 System.out.println(result.getString("payment_Id"));
								%>
							...
							Supplier_SELECT si =  new Supplier_SELECT(con,"select * from payment_Table");
					...
					<td style="width: 100%; height: 100%;">
						...
						<table style="height: 100%; width: 100%;">
								...
								<td style="height: 60%;">
									...
									<!-- form starts here  -->
										...
										<div class="container">
											...
											<form action="Payment_Filter_Delete_Controller" method="post">
											
												<label>Payement ID</label> 
												<br> <input type="text"	name="id_" placeholder="Your name.."> <br>
							...
							<!-- notification two  -->
								<tr>
									<td>
											 <form action="Payment_DELETE_Controller" method="post">
