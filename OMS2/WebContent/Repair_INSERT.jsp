				...
				<tr>
					...
					<td style="width: 70%;">
						...
						<div class="table-wrapper-scroll-y my-custom-scrollbar"
							...
							ResultSet result,resultset_for_dropdown,resultset_for_notification ;
							...
							System.out.println("this is the cirrent date " + currentdate);
							
							//job_id,cus_order_id,start_date
							Main_SELECT notification =  new Main_SELECT(con,"select *  from job_table where DATEDIFF( start_date,'2019-09-17') <= 2");
							
							resultset_for_notification =  notification.get_table();	
							//con.close();
							while(result.next())
							{
							%>
					...
					<td style="width: 100%; height: 100%;">
						...
						<table style="height: 100%; width: 100%;background-color: white;">
								...
								<td style="height: 100%;">
									...
									<!-- form starts here  -->
										...
										<div class="container">
											...
											<form action="Repair_INSERT" method="post" name="myForm" onsubmit="return validateForm()">
										
												
												<label>Select Customer</label><br>
												<select id="customerselect" style = "width : 100%;" name = "customerselect">
												...
												<label>Enter Your Error Here </label> <br>
												<input type="text" name="error"	> <br>

												<input type="submit" value="INSERT" style = "background-color:#008CBA; width:100%;">
