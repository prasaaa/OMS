				...
				<table class="table table-bordered table-striped mb-0"
					...
					<tr>
						<td style="padding: 0px 0px 0px 0px;">
							<form action="Stock_IN_Item_SELECT_Controller" method="POST"
								...
								<table id="MainTable"
									...
									<tbody>
										...
										<tr>
											...
											<td><form action="Inventory_INSERT_Controller"
													method="get">
													<input type="text" name="itemID"
														value="<%=results.getString(5)%>" hidden="true"> <input
														type="text" name="supID" value="<%=results.getString(4)%>"
														hidden="true"> <input type="text" name="itype"
														value="<%=results.getString(3)%>" hidden="true"> <input
										...
										<%
												...
												Inventory_SELECT si = new Inventory_SELECT(ConnectionManager.getConnection(),
														MySQLQueries.QUERY_SELECT_ALL_ITEM_INFO);
										...
										<tr>
											...
											<td><form action="Inventory_INSERT_Controller"
													method="get">
													<input type="text" name="itemID"
														value="<%=result.getString(5)%>" hidden="true"> <input
														type="text" name="supID" value="<%=result.getString(4)%>"
														hidden="true"> <input type="text" name="itype"
														value="<%=result.getString(3)%>" hidden="true"> <input
														type="submit" name="submitBtn" value="Add">
												</form></td>
