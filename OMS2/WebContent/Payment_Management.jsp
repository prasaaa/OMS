						...
						ResultSet result;
							...
							%>
								...
								<tr>
									...
									<td name><%= result.getString("payment_Id")%></td>
								...
								<td style="height: 40%;">
									...
									<!-- form starts here  -->
										...
										<div class="container">
											...
											<form action="Payment_INSERT_Controller" method="post">
											
												<label>payment id</label> <br> <input type="text"
													name="pid" placeholder="Your name.."> <br> 
													<label>date</label>
												<br> <input type="date" name="name"	placeholder="Your Pass..">
